...
public class StalagmiteWorldDecorator extends WorldDecorator {
    ...
    public StalagmiteWorldDecorator() {
        generatorList.addAll(StructureGenerator.STALAGMITES.REGISTRY.getAllEntries());
    ...
    public void decorate(World world, int cellX, int cellY) {
        ...
        int verticalCaveSpace = getCaveSpace(world, cellX, cellY, Direction.UP, maxStalactiteHeight);
        ...
        int spaceLeft = getCaveSpace(world, leftTestCellPosX, cellY, Direction.DOWN, testHeight);
        int spaceRight = getCaveSpace(world, rightTestCellPosX, cellY, Direction.DOWN, testHeight);
