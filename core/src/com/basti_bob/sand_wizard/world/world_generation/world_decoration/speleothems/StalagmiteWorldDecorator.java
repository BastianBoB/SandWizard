...
public class StalagmiteWorldDecorator extends SpeleothemWorldDecorator {
    ...
    public StalagmiteWorldDecorator() {
        super(SpeleothemWorldDecorator.builder()
                ...
                .addStructureList(StructureGenerator.STALAGMITES.LARGE.REGISTRY.getAllEntries(), 0.001f)
                .addStructureList(StructureGenerator.STALAGMITES.MEDIUM.REGISTRY.getAllEntries(), 0.003f)
