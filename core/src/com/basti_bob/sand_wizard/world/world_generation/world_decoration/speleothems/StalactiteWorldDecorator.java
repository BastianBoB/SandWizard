...
public class StalactiteWorldDecorator extends SpeleothemWorldDecorator {
    ...
    public StalactiteWorldDecorator() {
        super(SpeleothemWorldDecorator.builder()
                ...
                .addStructureList(StructureGenerator.STALACTITES.LARGE.REGISTRY.getAllEntries(), 0.001f)
                .addStructureList(StructureGenerator.STALACTITES.MEDIUM.REGISTRY.getAllEntries(), 0.003f)
