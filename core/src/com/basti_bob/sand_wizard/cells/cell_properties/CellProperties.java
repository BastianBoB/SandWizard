...
public class CellProperties {
    ...
    public static final LiquidProperties ACID = LiquidProperties.builder().allLiquid(5f, 0.75f).allLight(7f, 0.1f, Color.LIME).allBurn(100, 120, 0.1f).build();
    public static final LiquidProperties HYPER_ACID = LiquidProperties.builder().allLiquid(5f, 0.75f).allLight(7f, 0.1f, Color.LIME.cpy().mul(1.2f)).allBurn(100, 120, 0.1f).build();
    public static final LiquidProperties OIL = LiquidProperties.builder().allLiquid(4f, 0.5f).allBurn(100, 5, 0.7f).build();
    public static final LiquidProperties LAVA = LiquidProperties.builder().allLiquid(2f, 5f).allLight(10f, 0.1f, CellColors.c(255, 128, 0)).build();
