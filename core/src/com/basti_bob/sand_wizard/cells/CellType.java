...
public enum CellType {
    ...
    SUMMER_LEAF("summer_leaf", PhysicalState.SOLID, CellProperties.LEAF, ImmovableSolid::new, true, c(119, 163, 122), c(95, 146, 106), c(88, 126, 96)),
    SPRING_LEAF("spring_leaf", PhysicalState.SOLID, CellProperties.LEAF, ImmovableSolid::new, true, c(197, 227, 175), c(154, 195, 123), c(114, 162, 78), c(84, 134, 46)),

    WOOD("wood", PhysicalState.SOLID, CellProperties.WOOD, ImmovableSolid::new, true, hC(0x6E470B), hC(0x785115), hC(0x643D10)),
    RED_WOOD("red_wood", PhysicalState.SOLID, CellProperties.WOOD, ImmovableSolid::new, true, c(70, 31, 0), c(80, 41, 0), c(90, 51, 0)),

    SAND("sand", PhysicalState.SOLID, CellProperties.SAND, MovableSolid::new, true, hC(0xB8860C), hC(0xE7B744), hC(0xF1D581)),
    DIRT("dirt", PhysicalState.SOLID, CellProperties.DIRT, MovableSolid::new, true, hC(0xA0522D), hC(0x8B4513), hC(0xD2691E)),
    COAL("coal", PhysicalState.SOLID, CellProperties.COAL, MovableSolid::new, true, hC(0x363232), hC(0x292929), hC(0x393939)),
//
//    GUNPOWDER("Gunpowder", Gunpowder::new, PhysicalState.SOLID, true, hC(0x18181a), hC(0x1e1e21), hC(0x131315)),

    WATER("water", PhysicalState.LIQUID, CellProperties.WATER, Liquid::new, true, c(30, 125, 200), c(35, 137, 218), c(25, 115, 185)),

    OIL("oil", PhysicalState.LIQUID, CellProperties.OIL, Liquid::new, true, hC(0x0E0F0E), hC(0x0B0C0B), hC(0x121312)),
    //
//    ACID("Acid",PhysicalState.LIQUID, Acid::new, true, hC(0x9BE60F), hC(0xBFFF28), hC(0xAffA19)),
//
    FIRE("fire", PhysicalState.GAS, CellProperties.FIRE, Fire::new, true, hC(0xFF8800), hC(0xFF2200), hC(0xFFFF00),
...
//    STEAM("Steam",PhysicalState.GAS, Steam::new, true, hC(0xC7D5E0), hC(0xC7D5E0), hC(0xFFFFFF));
    ...
    METHANE("methane", PhysicalState.GAS, CellProperties.METHANE, Gas::new, true, hC(0xFFFFFF), hC(0xDDDDFF), hC(0xEEEEFF));
    ...
    CellType(String idName, PhysicalState physicalState, CellProperty cellProperty, CellSupplier cellSupplier, boolean addToEditor, Color... colors) {
        this.idName = idName;
